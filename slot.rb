...
class Board
  ...
  def random_generator
    ...
    # CODE FOR TEST FORCING THE ENTRY, just comment the 3 lines of above, and delete the character "#" from the following 4 lines   
...
class ReadLine   
  ...
  def hit!   
    ...
    if @payline_and_countmatch.length != 0  
      ...
      print "Sorry Not Won, execute again the script, ruby slot.rb" 
    end
